...
exports.run = async (bot, message, args) => {
  ...
  .addField("» **Botun Sahibi**", "<@696435185658363956> | Eos & Yankee#1871  ")
  .addField("» **Geliştirici** ", "<@696435185658363956> | Eos & Yankee#1871 ")
  ...
  .addField("**» Bot Davet**", " [Davet Et](https://discordapp.com/oauth2/authorize?client_id=835973268007288892&scope=bot&permissions=2146958847)")
 ...
 return message.channel.send(annencilermaldır);
   ...
   .setThumbnail(bot.user.displayAvatarURL({dynamic: true, format: "png", size: 1024}))
   .addField("» **Bot Owners**", "<@696435185658363956> | Eos & Yankee#1871  ")
   .addField("» **Developers** ","<@696435185658363956> | Eos & Yankee#1871 ")
   ...
   .addField("**» Bot Invite Url**", " [Davet Et](https://discordapp.com/oauth2/authorize?client_id=835973268007288892&scope=bot&permissions=2146958847)")
   .addField("**» Support server**", " [Join Our Server](.)")
