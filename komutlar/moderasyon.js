...
exports.run = async (bot, message, args) => {
  ...
  .addField('\u200b', '\u200B')
  .addField("**<:discord:793769836068470816> Önemliler**", " [Beni Davet et](https://discordapp.com/oauth2/authorize?client_id=835973268007288892&scope=bot&permissions=2146958847) \n[Destek Sunucusu](.)")
 ...
 return msg.channel.send(annencilermaldır);
  ...
  let onlycode = args.slice(0).join(' ');
    ...
    .addField(`**<:fixit:793770061386743818> Timed Unmute**`, `${prefix}unmute`, false)
      .addField('\u200b', '\u200B')
    .addField("**<:discord:793769836068470816> Important**", " [Invite Me](https://discordapp.com/oauth2/authorize?client_id=835973268007288892&scope=bot&permissions=2146958847) \n[Support Realm](https://discord.gg/.)")
